...
PlayerGUI::PlayerGUI(PlayerAudio& audio_player) : player(audio_player) {
    // Add buttons
    for (auto* btn : { &loadButton, &restartButton , &stopButton, &muteButton, &playPauseButton, &toEnd, &toStart, & loopButton })
    {
...
void PlayerGUI::resized() {
    ...
    loopButton.setBounds(buttons_x - 3 * distance_factor * button_margin, buttons_y, buttons_w, buttons_h);
    toStart.setBounds(buttons_x + 3 * distance_factor * button_margin, buttons_y, buttons_w, buttons_h);
    toEnd.setBounds(buttons_x - 4 * distance_factor * button_margin, buttons_y, buttons_w, buttons_h);
